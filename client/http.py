...
class SyncCancelled(Exception):
    """Sinal de cancelamento solicitado pelo usuário."""
...
class SyncClient:
    ...
    def download(self, remote_file: str, local_path, cancel=None):
    ...
    def upload(self, local_path, remote_file: str, cancel=None):
    ...
    def download_archive(self, base_path, files, local_dest, log_fn, progress_fn=None, cancel=None):
    ...
    def upload_archive(self, to_upload, remote_dest, log_fn, progress_fn=None, cancel=None):
        import zstandard as zstd
...
def do_auth(host: str, password: str) -> str:
    ...
    if r.status_code == 429:
        raise ValueError("Muitas tentativas. Aguarde 1 minuto.")
    r.raise_for_status()
    return r.json()["token"]
